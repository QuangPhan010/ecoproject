...
urlpatterns = [
    ...
    path('orders/<int:order_id>/refund/', views.refund_request_create, name='refund_request_create'),
    path('refund-requests/', views.refund_request_list, name='refund_request_list'),
